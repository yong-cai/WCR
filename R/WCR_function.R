...
#' @param subclust The fine level of clustering that is correct under the null hypothesis.
#' @param clust The coarse level of clustering that is correct under the alternative hypothesis. 
#' @param alpha The size of the test. 5% by default. 
#' @export
#' @examples 
#' # Generate data
...
#-------------------------------------------------------------------------------
wcr_test  <- function(Xtilde, resids, subclust, clust, alpha = 0.05){
  #-----------------------------------------------------------------------------
